...
import { InviteBatchCopy, InviteBatchDelete, InviteBatchToggle, InviteCreator, InviteBatchViewButton } from "@/components/admin/admin-actions";
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-end justify-start gap-2 xl:justify-end">
                  <InviteBatchViewButton batchId={batch.id} title={batch.title} />
